...
contract TSwapPool is ERC20 {
    ...
    constructor(
        ...
        // written: lacking 0 address check
    ...
    function deposit(
        ...
        if (totalLiquidityTokenSupply() > 0) {
            ...
            // written: it would be better if this was before `_addLiquidityMintAndTransfer` call to follow CEI
    ...
    function _addLiquidityMintAndTransfer(
        ...
        // written: this is backward should be (msg.sender, wethToDeposit, poolTokensToDeposit)
        ...
        returns (uint256 inputAmount)
    {
        ...
        // written: magic numbers
        // 91.3% fee
        // written: users are charged too much fee
        // IMPACT-HIGH: users are charged too much fee
     ...
     * written missing deadline param in natspec
     */
        ...
        returns (uint256 inputAmount)
    {
        ...
        // written: need a max input amount check
        // slippage check
        // MEV Attack
    ...
    function sellPoolTokens(uint256 poolTokenAmount) external returns (uint256 wethAmount) {
        ...
        // swapExactInput() should be used here
    ...
    function _swap(IERC20 inputToken, uint256 inputAmount, IERC20 outputToken, uint256 outputAmount) private {
        if (
            _isUnknown(inputToken) || _isUnknown(outputToken) || 
                // written: Comparison of variables of contract type is deprecated and scheduled for removal. Use an explicit cast to address type and compare the addresses instead.
